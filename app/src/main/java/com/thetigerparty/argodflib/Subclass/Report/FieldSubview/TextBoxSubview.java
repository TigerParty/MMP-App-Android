 ...
 */
public class TextBoxSubview extends LinearLayout implements DynamicForm {
    ...
    public TextBoxSubview(Context context) {
        super(context);
    }

    public TextBoxSubview(Context context, FormFieldObject obj_form_field){
        super(context);
